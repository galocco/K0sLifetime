...
#ifndef MassvsLifetimes_h
#define MassvsLifetimes_h
...
class MassvsLifetimes : public TSelector {
...
public:
  ...
  MassvsLifetimes(TTree * /*tree*/ =0);
  virtual ~MassvsLifetimes() { }
  ...
  TH2D* fHistArment; // Armenteros plot
  TH3D* fHistInvMassK0sCt; //Invariant mass of K0s vs ct
  TH2D* fHistInvMassLambdaCt; //Invariant mass of (anti)Lambda vs ct
  TH2D* fHistAntiLambda; // //Invariant mass of AntiLamba vs ct
  TH2D* fHistLambda; //Invariant mass of Lambda vs ct

  TDatabasePDG pdg;
  ClassDef(MassvsLifetimes,0);
